...
include_once \dirname(__DIR__, 4).'/src/DataFixtures/RoomTestFixtures.php';
include_once \dirname(__DIR__, 4).'/src/DataFixtures/UserFixtures.php';
include_once \dirname(__DIR__, 4).'/src/DataFixtures/UserTestFixtures.php';
...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\RoomFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\RoomTestFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UserTestFixtures(), 'groups' => []]]);
