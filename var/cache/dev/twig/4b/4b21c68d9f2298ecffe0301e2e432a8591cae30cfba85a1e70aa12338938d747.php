...
/* layout.html.twig */
class __TwigTemplate_f547e71a5b63ca20b17dca075e722f65cc5cd1749c9cdc19faabcc67da592380 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <style>
        ...
        // line 11
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/ADS-logo-blanc.png"), "html", null, true);
        echo ");
...
";
    ...
    ";
        // line 27
        $this->loadTemplate("components/_navbar.html.twig", "layout.html.twig", 27)->display($context);
        // line 28
        echo "
    ";
        // line 30
...
";
    ...
    {
        return array (  180 => 39,  176 => 37,  166 => 36,  147 => 30,  136 => 33,  134 => 32,  132 => 31,  129 => 30,  126 => 28,  124 => 27,  121 => 26,  111 => 25,  88 => 11,  81 => 7,  76 => 5,  71 => 4,  61 => 3,  38 => 1,);
    }
...
{% block stylesheets %}
    ...
    <style>
        body:after {
            content: \"\";
            background-image: url({{ asset('images/ADS-logo-blanc.png') }});
            background-repeat:no-repeat;
            background-position:center center;
            opacity: 0.2;
            top: 0;
...
", "layout.html.twig", "/home/sankofa-impact/www-bass/reunionIT/templates/layout.html.twig");
    }
}
