...
class __TwigTemplate_00c95457474a481d07a06a34bbb69854b5c1e683697941af3325dc3a3835f586 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "</h1>
        <p><img src=\"http://newapps.cs50.net/img/error403.gif\" alt=\"Erreur 403\"></p>
        <a href=\"";
        // line 11
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("index");
        echo "\" class=\"my-btn btn-go-home\">
...
";
    ...
    {
        return array (  100 => 11,  95 => 9,  92 => 8,  82 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    <div class=\"page-404\">
        <h1>Accès Refusé {{ status_code }}</h1>
        <p><img src=\"http://newapps.cs50.net/img/error403.gif\" alt=\"Erreur 403\"></p>
        <a href=\"{{ path('index') }}\" class=\"my-btn btn-go-home\">
            RETOURNER VERS L'ACCUEIL
        </a>
    </div>
{% endblock %}", "@Twig/Exception/error403.html.twig", "/home/sankofa-impact/www-bass/reunionIT/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
